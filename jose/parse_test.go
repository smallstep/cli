...
var pemFiles = map[string]testdata{
	"../crypto/pem/testdata/openssl.p256.pem":              {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/openssl.p256.pub.pem":          {ecdsaPublicKey, false},
	"../crypto/pem/testdata/openssl.p256.enc.pem":          {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/openssl.p384.pem":              {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/openssl.p384.pub.pem":          {ecdsaPublicKey, false},
	"../crypto/pem/testdata/openssl.p384.enc.pem":          {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/openssl.p521.pem":              {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/openssl.p521.pub.pem":          {ecdsaPublicKey, false},
	"../crypto/pem/testdata/openssl.p521.enc.pem":          {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/openssl.rsa1024.pem":           {rsaPrivateKey, false},
	"../crypto/pem/testdata/openssl.rsa1024.pub.pem":       {rsaPublicKey, false},
	"../crypto/pem/testdata/openssl.rsa1024.enc.pem":       {rsaPrivateKey, true},
	"../crypto/pem/testdata/openssl.rsa2048.pem":           {rsaPrivateKey, false},
	"../crypto/pem/testdata/openssl.rsa2048.pub.pem":       {rsaPublicKey, false},
	"../crypto/pem/testdata/openssl.rsa2048.enc.pem":       {rsaPrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.ed25519.pem":     {ed25519PrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.ed25519.pub.pem": {ed25519PublicKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.ed25519.enc.pem": {ed25519PrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.p256.pem":        {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p256.pub.pem":    {ecdsaPublicKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p256.enc.pem":    {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.p384.pem":        {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p384.pub.pem":    {ecdsaPublicKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p384.enc.pem":    {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.p521.pem":        {ecdsaPrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p521.pub.pem":    {ecdsaPublicKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.p521.enc.pem":    {ecdsaPrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.rsa2048.pem":     {rsaPrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.rsa2048.pub.pem": {rsaPublicKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.rsa2048.enc.pem": {rsaPrivateKey, true},
	"../crypto/pem/testdata/pkcs8/openssl.rsa4096.pem":     {rsaPrivateKey, false},
	"../crypto/pem/testdata/pkcs8/openssl.rsa4096.pub.pem": {rsaPublicKey, false},
}
